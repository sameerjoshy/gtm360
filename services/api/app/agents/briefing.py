...
SCHEMA = """Return JSON:
{
  ...
  "plan_link": "Compass (okr.gtm-360.com)",
  "escalations": [{"summary": "..."}],
...
""",
            ...
            # OKRs are planned in Compass (okr.gtm-360.com); this snapshot is read-only reference.
            memo["plan_link"] = "Compass (okr.gtm-360.com)"
